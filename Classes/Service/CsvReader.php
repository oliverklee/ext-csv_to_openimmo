...
class CsvReader implements SingletonInterface
{
    ...
    private static $columnKeys = [
        ...
        17 => 'livingArea',
        18 => 'heatingType',
        23 => 'rentWithoutHeatingCosts',
        24 => 'additionalCosts',
        26 => 'heatingIncludedInAdditionalCosts',
        27 => 'rentWithHeatingCosts',
        29 => 'deposit',
        30 => 'title',
        32 => 'location',
        33 => 'description',
    ...
    private static $ignoredColumns = [
        ...
        35 => 'elevator (not available as text field in OpenImmo)',
        36 => 'balcony (not available as text field in OpenImmo)',
        37 => 'Kellerbox 401',
        46 => 'garageType (not available as text field in OpenImmo)',
